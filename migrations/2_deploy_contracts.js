...
const voters = [
  '0x' + '92b34907ec85874ab6faadaa1fd32b3e86c1211c8fb9350a8bf13bd5caf1ff29',
  '0x' + '5d18f5dbfb0469a7136a3f3f95f46b3b1dbf434e1f9d95574ed8d40f8a40d0f1',
];
...
module.exports = async function(deployer) {
  ...
  console.log(toHex(voters));
  await deployer.deploy(Voting, registerAdd.address, web3.utils.asciiToHex('treeRoot'), voters, toHex(candidates2), setup);
};
